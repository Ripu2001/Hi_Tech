        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="myTable" class="table table-striped table-dark table-dark table-hover" >
                            <thead>
                                <tr>
                                    <th>SL No.</th>
                                    <th>Title</th>
                            ...
                            <tbody>
                                @foreach ($rows as $key=> $row)
                                    <tr>
                                        ...
                                        <td>{{$row->title}}</td>
                                        <td>
                                            <img style="width:70px" src="{{asset($path.'/'.$row->image_path)}}" alt="">
                                        </td>
                                        <td>
                                            @if($row->status==1)
